...
function LeftSideBar() {
    ...
    return (
        <nav className=' bg-neutral-700 hidden md:flex px-6 py-10 flex-col justify-between min-w-[300px] bg-dark-2'>
            <div className='flex flex-col gap-11'>
                ...
                <ul className=' flex flex-col gap-6 '>
                    {sidebarLinks.map((link: INavLink) => {
                        ...
                        return (
                            <li className={`leftsidebar-link bg-neutral-700 ${isActive &&
            ...
            <Button onClick={() => signOut()} className='flex pl-4 py-4 bg-neutral-700gap-4 items-center justify-start hover:bg-violet-300'>
